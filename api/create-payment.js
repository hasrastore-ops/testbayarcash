...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const payload = {
            payment_channel: 1, portal_key: PORTAL_KEY, order_number: orderNumber,
            amount: amount * 100, payer_name: name, payer_email: email,
            payer_telephone_number: phone, return_url: returnUrl, callback_url: callbackUrl,
        };

        payload.checksum = generateChecksum(payload, API_SECRET_KEY);
